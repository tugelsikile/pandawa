...
<head>
    ...
    <style>
        *{
            font-family: 'CANDARA' !important; font-size:8pt !important;
            line-height:15px;
        }
        .kolom{
            width:45%;
        }
        .kolom div, .kolom table td{ font-size:10pt !important; }
        .align-right{ text-align: right }
        .company-name{ font-size:12pt !important;}
        .inv_number{
            font-size:18pt !important; color: #2b669a; clear: both; margin:10px auto;
        }
        .invtable{
