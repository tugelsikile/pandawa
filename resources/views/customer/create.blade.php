...
<div class="tab-content" id="nav-tabContent">
    ...
    <div style="padding-top:20px" class="tab-pane fade show" id="nav-layanan" role="tabpanel" aria-labelledby="nav-layanan-tab">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="alamat_ip" id="alamat_ip" required>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-4">
                <input min="0" max="9999999999" value="100000" type="number" class="form-control" name="biaya_instalasi" id="biaya_instalasi">
            </div>
        </div>
        <div class="form-group row">
            ...
            <label class="col-sm-2 col-form-label" for="tanggal_instalasi">Tanggal Instalasi</label>
            <div class="col-sm-4">
                <input type="text" name="tanggal_instalasi" class="form-control" id="tanggal_instalasi" required>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $('#tanggal_instalasi,#tanggal_pemasangan').datepicker({
        autoclose   : true,
        format      : 'yyyy-mm-dd'
    });
    ...
    getKabPenagihan();
    $('.flag-npwp').hide();
    $('#nama_produk,#nama_cabang,.village_id,.regency_id,.province_id,.district_id,#provinsi_penagihan,#kabupaten_penagihan,#kecamatan_penagihan,#desa_penagihan').select2();
