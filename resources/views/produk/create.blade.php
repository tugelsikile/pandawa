...
<div class="form-group">
    <label class="col-sm-2 control-label" for="kode_produk">Kode Produk</label>
    <div class="col-sm-4">
        <input type="text" class="form-control" id="kode_produk" name="kode_produk" required>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-2 control-label" for="nama_produk">Nama Produk</label>
    <div class="col-sm-10">
        <input type="text" class="form-control" name="nama_produk" id="nama_produk" required>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-2 control-label" for="keterangan_produk">Keterangan Produk</label>
    <div class="col-sm-10">
        <textarea name="keterangan_produk" id="keterangan_produk" class="form-control"></textarea>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-2 control-label" for="kapasitas">Kapasitas</label>
    <div class="col-sm-2">
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="harga_produk">Harga Produk</label>
    <div class="col-sm-4">
    ...
    <label class="col-sm-4 control-label" for="pajak_produk">Pajak %</label>
    <div class="col-sm-2">
...
<div class="form-group">
    <label class="col-sm-2 control-label">Preview Harga</label>
    <div class="col-sm-4">
        <input type="text" class="form-control" id="preview_harga" disabled>
    </div>
</div>
<script>
    if ($('.cab_id').val().length > 0){
        $('#nama_cabang').val($('.cab_id').val());
    }
    kodeProduk();
    previewHarga();
