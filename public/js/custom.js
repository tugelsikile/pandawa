...
function getKab(obj,defaultRegencyID){
    ...
    $.ajax({
        url     : window.origin + '/api/regional/get-kab',
        type    : 'GET',
        dataType: 'JSON',
        data    : { id : prov_id },
        error   : function (e) {
...
function getKec(obj,defaultDistrictID) {
    ...
    $.ajax({
        url     : window.origin + '/api/regional/get-kec',
        type    : 'GET',
        dataType: 'JSON',
        data    : { id : kab_id },
        error   : function (e) {
...
function getDesa(obj,defaultDesaID) {
    ...
    $.ajax({
        url     : window.origin + '/api/regional/get-desa',
        type    : 'GET',
        dataType: 'JSON',
        data    : { id : kab_id },
        error   : function (e) {
...
function tagihanInformasi(url,token,bulan,tahun,cabang,npwp,active,paid,mitra){
    ...
    $.ajax({
        ...
        type    : 'POST',
        dataType: 'JSON',
        data    : { _token : token, bulan : bulan, tahun : tahun, cab_id : cabang, npwp : npwp, is_active : active, paid : paid, mitra : mitra },
        error   : function (e) {
